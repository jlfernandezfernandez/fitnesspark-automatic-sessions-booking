...
const DayColumn: React.FC<DayColumnProps> = ({ day, userId }) => {
  ...
  return (
    <div className="relative flex flex-col items-center m-1 p-3 sm:p-6 min-h-[450px] sm:min-h-[500px] w-full sm:w-auto bg-gray-100 dark:bg-gray-800 rounded dark:text-white">
